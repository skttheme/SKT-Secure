...
define('SKT_SECURE_SKTTHEMES_URL','https://www.sktthemes.org/');
define('SKT_SECURE_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.org/shop/security-company-wordpress-theme');
define('SKT_SECURE_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.org/shop/free-security-wordpress-theme');
define('SKT_SECURE_SKTTHEMES_THEME_DOC','http://sktthemesdemo.net/documentation/secure-pro-documentation');
define('SKT_SECURE_SKTTHEMES_LIVE_DEMO','https://www.sktperfectdemo.com/demos/securepro/');
define('SKT_SECURE_SKTTHEMES_THEMES','https://www.sktthemes.org/themes');
